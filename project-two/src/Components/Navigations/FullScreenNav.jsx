    ...
    return (
        <div ref={fullScreenRef} id='fullscreennav' className='fullscreennav hidden text-white overflow-hidden h-screen w-full z-50 absolute'>
            ...
            <div ref={fullNavLinksRef} className='relative'>
                ...
                <div className=''>
                    <div className='link origin-top mt-0 relative overflow-hidden border-t-1 border-white'>
                        <h1 className='font-[font2] text-4xl lg:text-[7vw] text-center lg:leading-[0.8] lg:pt-5 pt-3 uppercase'>Projets</h1>
                        <div className='moveLink absolute flex items-center justify-center inset-0 bg-[#D3FD50] text-black'>
                            <div className='moveX flex items-center'>
                                ...
                                <img className='lg:h-18 h-12 rounded-full shrink-0 lg:w-76 w-30 object-cover' src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-5xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase'>Pour Tout voir</h2>
                                <img className='lg:h-18 h-12 rounded-full shrink-0 lg:w-76 w-30 object-cover' src="https://k72.ca/uploads/caseStudies/PJC/Thumbnails/PJC_SiteK72_Thumbnail_640x290-640x290.jpg" alt="" />
                            </div>
                            <div className='moveX flex items-center'>
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-5xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase'>Pour Tout voir</h2>
